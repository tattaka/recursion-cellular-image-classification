...
class Config(object):
    def __init__(self):
        ...
        self.pseudo_labeling_path = "result_densenet121_leak_hungarian_probs.npy"
        ...
        self.num_class = 1108
        self.backborn_cfg = {'name': 'densenet121', 'pretrain': False, 'layer': 'features'}
        ...
        self.lr_points = [self.max_epoch*0.50, self.max_epoch*0.75]
